...
| Get Api  | `/sdwan/v4.21/api/sites/{site_id}/elements/{element_id}/interfaces/{interface_id}` (`InterfaceScreenV4N21`) |
| Post Api  | `/sdwan/v4.21/api/sites/{site_id}/elements/{element_id}/interfaces` (`InterfaceScreenV4N21`) |
| Put Api  | `/sdwan/v4.21/api/sites/{site_id}/elements/{element_id}/interfaces/{interface_id}` (`InterfaceScreenV4N21`) |
| Delete Api  | `/sdwan/v4.21/api/sites/{site_id}/elements/{element_id}/interfaces/{interface_id}` |
