## Documentation for Prisma SDWAN Resource "performance_policy_set"

### Overview

| Resource Details | |
| ------------- | ------------- |
| Resource Name | `performance_policy_set` |
| Get Api  | `/sdwan/v2.0/api/perfmgmtpolicysets/{perfmgmtpolicyset_id}` (`PerfMgmtPolicySet`) |
| Post Api  | `/sdwan/v2.0/api/perfmgmtpolicysets` (`PerfMgmtPolicySet`) |
| Put Api  | `/sdwan/v2.0/api/perfmgmtpolicysets/{perfmgmtpolicyset_id}` (`PerfMgmtPolicySet`) |
| Delete Api  | `/sdwan/v2.0/api/perfmgmtpolicysets/{perfmgmtpolicyset_id}` |
...
```json
import {
 to="prismasdwan_performance_policy_set.my_resource_name"
 id="<resource_id>"
}
```
