...
output "configuration_validation" {
  ...
  value = {
    ...
    enum_validation = {
      ...
      valid_sgi_vendor = var.sgi_config == null || var.sgi_config.sgi_vendor_id == "SGI_VENDOR_ID_TYPE_8909"
    }
    ...
    constraint_validation = {
      ...
      sgi_tag_range_ok = var.sgi_config == null || (var.sgi_config.sgi_tag >= 1 && var.sgi_config.sgi_tag <= 65533)
    ...
    deployment_readiness = {
      all_validations_pass = (
        ...
        (var.sgi_config == null || (var.sgi_config.sgi_vendor_id == "SGI_VENDOR_ID_TYPE_8909" && var.sgi_config.sgi_tag >= 1 && var.sgi_config.sgi_tag <= 65533)) &&
        (var.location == null || (
          (var.location.latitude == null || (var.location.latitude >= -90 && var.location.latitude <= 90)) &&
          (var.location.longitude == null || (var.location.longitude >= -180 && var.location.longitude <= 180))
        ))
