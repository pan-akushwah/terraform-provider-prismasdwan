...
// Schema: #/components/schemas/CustomDHCPOptions
...
Param VendorClassIdentifier (string): Vendor Class Identifier
*/
type Config struct {
	OptionDefinition      string  `json:"option_definition"`
	OptionValue           string  `json:"option_value"`
	VendorClassIdentifier *string `json:"vendor_class_identifier"`
}
