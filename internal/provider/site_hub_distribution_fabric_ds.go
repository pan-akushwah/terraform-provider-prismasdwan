...
// Data source.
var (
	_ datasource.DataSource              = &siteHubDistributionFabricDataSource{}
	_ datasource.DataSourceWithConfigure = &siteHubDistributionFabricDataSource{}
)
...
//	     }
//	  }
func NewSiteHubDistributionFabricDataSource() datasource.DataSource {
	return &siteHubDistributionFabricDataSource{}
}

type siteHubDistributionFabricDataSource struct {
	client *sdwan.Client
}

type dsModelWithFilterSiteHubDistributionFabric struct {
	...
	Items        []*dsModelPrefixDistributionSpokeList `tfsdk:"items"`
}

// Metadata returns the data source type name.
func (d *siteHubDistributionFabricDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
			...
			"items": dsschema.ListNestedAttribute{
				...
				NestedObject: dsschema.NestedAttributeObject{
					Attributes: map[string]dsschema.Attribute{
						...
						"spoke_site_ids": dsschema.ListAttribute{
							Required:    false,
							Computed:    false,
							Optional:    true,
							Sensitive:   false,
...
func (d *siteHubDistributionFabricDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *siteHubDistributionFabricDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterSiteHubDistributionFabric
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_site_hub_distribution_fabric", (*list_request.ResponseErr).Error())
		}
		return
	}
	...
	for _, item := range response.Items {
		...
		var state dsModelPrefixDistributionSpokeList
		...
		// if found, exit
		if json_err != nil {
			resp.Diagnostics.AddError("error in json unmarshal to PrefixDistributionSpokeList", json_err.Error())
			return
		}
