...
// Data source.
var (
	_ datasource.DataSource              = &siteHubPrefixFilterAssociationDataSource{}
	_ datasource.DataSourceWithConfigure = &siteHubPrefixFilterAssociationDataSource{}
)
...
//	     }
//	  }
func NewSiteHubPrefixFilterAssociationDataSource() datasource.DataSource {
	return &siteHubPrefixFilterAssociationDataSource{}
}

type siteHubPrefixFilterAssociationDataSource struct {
	client *sdwan.Client
}

type dsModelWithFilterSiteHubPrefixFilterAssociation struct {
	...
	Items        []*dsModelPathPrefixDistributionFiltersAssociation `tfsdk:"items"`
}

// Metadata returns the data source type name.
func (d *siteHubPrefixFilterAssociationDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_site_hub_prefix_filter_association"
}

// Schema defines the schema for this data source.
func (d *siteHubPrefixFilterAssociationDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *siteHubPrefixFilterAssociationDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *siteHubPrefixFilterAssociationDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterSiteHubPrefixFilterAssociation
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_site_hub_prefix_filter_association", (*list_request.ResponseErr).Error())
		}
		return
	}
