...
// Data source.
var (
	_ datasource.DataSource              = &siteQosPolicyLocalPrefixDataSource{}
	_ datasource.DataSourceWithConfigure = &siteQosPolicyLocalPrefixDataSource{}
)
...
//	     }
//	  }
func NewSiteQosPolicyLocalPrefixDataSource() datasource.DataSource {
	return &siteQosPolicyLocalPrefixDataSource{}
}

type siteQosPolicyLocalPrefixDataSource struct {
	client *sdwan.Client
}

type dsModelWithFilterSiteQosPolicyLocalPrefix struct {
	...
	Items        []*dsModelSitePriorityPrefixAssociationV2N1 `tfsdk:"items"`
}

// Metadata returns the data source type name.
func (d *siteQosPolicyLocalPrefixDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_site_qos_policy_local_prefix"
}

// Schema defines the schema for this data source.
func (d *siteQosPolicyLocalPrefixDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *siteQosPolicyLocalPrefixDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *siteQosPolicyLocalPrefixDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterSiteQosPolicyLocalPrefix
	...
	get_path := "/sdwan/v2.1/api/sites/{site_id}/prioritypolicylocalprefixes/{prefix_id}"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_site_qos_policy_local_prefix", (*list_request.ResponseErr).Error())
		}
		return
	}
	...
	for _, item := range response.Items {
		...
		var state dsModelSitePriorityPrefixAssociationV2N1
		...
		// if found, exit
		if json_err != nil {
			resp.Diagnostics.AddError("error in json unmarshal to SitePriorityPrefixAssociationV2N1", json_err.Error())
			return
		}

		// lets copy all items into state schema=SitePriorityPrefixAssociationV2N1
