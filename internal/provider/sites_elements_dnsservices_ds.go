...
// Data source.
var (
	_ datasource.DataSource              = &sitesElementsDnsservicesDataSource{}
	_ datasource.DataSourceWithConfigure = &sitesElementsDnsservicesDataSource{}
)
...
//	     NewSitesElementsDnsservicesDataSource,
//	     // -- append next datasource above -- //
//	     }
//	  }
func NewSitesElementsDnsservicesDataSource() datasource.DataSource {
	return &sitesElementsDnsservicesDataSource{}
}

type sitesElementsDnsservicesDataSource struct {
	client *sdwan.Client
}

// Metadata returns the data source type name.
func (d *sitesElementsDnsservicesDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_sites_elements_dnsservices"
}

// Schema defines the schema for this data source.
func (d *sitesElementsDnsservicesDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *sitesElementsDnsservicesDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *sitesElementsDnsservicesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if read_request.ResponseErr != nil {
		if IsObjectNotFound(*read_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_sites_elements_dnsservices", (*read_request.ResponseErr).Error())
		}
		return
	}
