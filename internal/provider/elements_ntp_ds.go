...
// Data source.
var (
	_ datasource.DataSource              = &elementsNtpDataSource{}
	_ datasource.DataSourceWithConfigure = &elementsNtpDataSource{}
)
...
//	     NewElementsNtpDataSource,
//	     // -- append next datasource above -- //
//	     }
//	  }
func NewElementsNtpDataSource() datasource.DataSource {
	return &elementsNtpDataSource{}
}

type elementsNtpDataSource struct {
	client *sdwan.Client
}

// Metadata returns the data source type name.
func (d *elementsNtpDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_elements_ntp"
}

// Schema defines the schema for this data source.
func (d *elementsNtpDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *elementsNtpDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *elementsNtpDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if read_request.ResponseErr != nil {
		if IsObjectNotFound(*read_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_elements_ntp", (*read_request.ResponseErr).Error())
		}
		return
	}
