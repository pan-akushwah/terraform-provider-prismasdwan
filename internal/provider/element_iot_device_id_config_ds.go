...
// Data source.
var (
	_ datasource.DataSource              = &elementIotDeviceIdConfigDataSource{}
	_ datasource.DataSourceWithConfigure = &elementIotDeviceIdConfigDataSource{}
)
...
//	     }
//	  }
func NewElementIotDeviceIdConfigDataSource() datasource.DataSource {
	return &elementIotDeviceIdConfigDataSource{}
}

type elementIotDeviceIdConfigDataSource struct {
	client *sdwan.Client
}

type dsModelWithFilterElementIotDeviceIdConfig struct {
	...
	Items        []*dsModelDeviceIdElementConfigScreen `tfsdk:"items"`
}

// Metadata returns the data source type name.
func (d *elementIotDeviceIdConfigDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_element_iot_device_id_config"
}

// Schema defines the schema for this data source.
func (d *elementIotDeviceIdConfigDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
			...
			"items": dsschema.ListNestedAttribute{
				...
				NestedObject: dsschema.NestedAttributeObject{
					Attributes: map[string]dsschema.Attribute{
						...
						"snmp_discovery_source_interface_id": dsschema.StringAttribute{
							Required:  false,
							Computed:  false,
							Optional:  true,
							Sensitive: false,
...
func (d *elementIotDeviceIdConfigDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *elementIotDeviceIdConfigDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterElementIotDeviceIdConfig
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_element_iot_device_id_config", (*list_request.ResponseErr).Error())
		}
		return
	}
	...
	for _, item := range response.Items {
		...
		var state dsModelDeviceIdElementConfigScreen
		...
		// if found, exit
		if json_err != nil {
			resp.Diagnostics.AddError("error in json unmarshal to DeviceIdElementConfigScreen", json_err.Error())
			return
		}
