...
// Data source.
var (
	_ datasource.DataSource              = &sitePathPolicyLocalPrefixDataSource{}
	_ datasource.DataSourceWithConfigure = &sitePathPolicyLocalPrefixDataSource{}
)
...
//	     }
//	  }
func NewSitePathPolicyLocalPrefixDataSource() datasource.DataSource {
	return &sitePathPolicyLocalPrefixDataSource{}
}

type sitePathPolicyLocalPrefixDataSource struct {
	client *sdwan.Client
}

type dsModelWithFilterSitePathPolicyLocalPrefix struct {
	...
	Items        []*dsModelSiteNetworkPrefixAssociationV2N1 `tfsdk:"items"`
}

// Metadata returns the data source type name.
func (d *sitePathPolicyLocalPrefixDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_site_path_policy_local_prefix"
}

// Schema defines the schema for this data source.
func (d *sitePathPolicyLocalPrefixDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *sitePathPolicyLocalPrefixDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *sitePathPolicyLocalPrefixDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterSitePathPolicyLocalPrefix
	...
	get_path := "/sdwan/v2.1/api/sites/{site_id}/networkpolicylocalprefixes/{prefix_id}"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_site_path_policy_local_prefix", (*list_request.ResponseErr).Error())
		}
		return
	}
	...
	for _, item := range response.Items {
		...
		var state dsModelSiteNetworkPrefixAssociationV2N1
		...
		// if found, exit
		if json_err != nil {
			resp.Diagnostics.AddError("error in json unmarshal to SiteNetworkPrefixAssociationV2N1", json_err.Error())
			return
		}

		// lets copy all items into state schema=SiteNetworkPrefixAssociationV2N1
