...
// Data source.
var (
	_ datasource.DataSource              = &siteHubClusterDataSource{}
	_ datasource.DataSourceWithConfigure = &siteHubClusterDataSource{}
)
...
//	     }
//	  }
func NewSiteHubClusterDataSource() datasource.DataSource {
	return &siteHubClusterDataSource{}
}

type siteHubClusterDataSource struct {
	client *sdwan.Client
}

type dsModelWithFilterSiteHubCluster struct {
	...
	Items        []*dsModelHubClusterV4 `tfsdk:"items"`
}

// Metadata returns the data source type name.
func (d *siteHubClusterDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *siteHubClusterDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *siteHubClusterDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterSiteHubCluster
	...
	get_path := "/sdwan/v4.0/api/sites/{site_id}/hubclusters/{hub_cluster_id}"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_site_hub_cluster", (*list_request.ResponseErr).Error())
		}
		return
	}
