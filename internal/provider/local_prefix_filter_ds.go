...
// Data source.
var (
	_ datasource.DataSource              = &localPrefixFilterDataSource{}
	_ datasource.DataSourceWithConfigure = &localPrefixFilterDataSource{}
)
...
//	     }
//	  }
func NewLocalPrefixFilterDataSource() datasource.DataSource {
	return &localPrefixFilterDataSource{}
}

type localPrefixFilterDataSource struct {
	client *sdwan.Client
}

type dsModelWithFilterLocalPrefixFilter struct {
	...
	Items        []*dsModelLocalPrefixFilterScreen `tfsdk:"items"`
}

// Metadata returns the data source type name.
func (d *localPrefixFilterDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_local_prefix_filter"
}

// Schema defines the schema for this data source.
func (d *localPrefixFilterDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *localPrefixFilterDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *localPrefixFilterDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterLocalPrefixFilter
	...
	get_path := "/sdwan/v2.0/api/localprefixfilters/{id}"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_local_prefix_filter", (*list_request.ResponseErr).Error())
		}
		return
	}
	...
	for _, item := range response.Items {
		...
		var state dsModelLocalPrefixFilterScreen
		...
		// if found, exit
		if json_err != nil {
			resp.Diagnostics.AddError("error in json unmarshal to LocalPrefixFilterScreen", json_err.Error())
			return
		}
