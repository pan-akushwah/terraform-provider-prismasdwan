...
type dsModelWithFilterElementToolkit struct {
	...
	Items        []*dsModelElementAccessConfigScreenV2N2 `tfsdk:"items"`
}
...
func (d *elementToolkitDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var state_with_filter dsModelWithFilterElementToolkit
	...
	get_path := "/sdwan/v2.2/api/elements/{element_id}/elementaccessconfigs"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_element_toolkit", (*list_request.ResponseErr).Error())
		}
		return
	}
