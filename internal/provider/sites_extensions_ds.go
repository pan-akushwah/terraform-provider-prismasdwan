...
// Data source.
var (
	_ datasource.DataSource              = &sitesExtensionsDataSource{}
	_ datasource.DataSourceWithConfigure = &sitesExtensionsDataSource{}
)
...
//	     NewSitesExtensionsDataSource,
//	     // -- append next datasource above -- //
//	     }
//	  }
func NewSitesExtensionsDataSource() datasource.DataSource {
	return &sitesExtensionsDataSource{}
}

type sitesExtensionsDataSource struct {
	client *sdwan.Client
}

// Metadata returns the data source type name.
func (d *sitesExtensionsDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_sites_extensions"
}

// Schema defines the schema for this data source.
func (d *sitesExtensionsDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *sitesExtensionsDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *sitesExtensionsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if read_request.ResponseErr != nil {
		if IsObjectNotFound(*read_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_sites_extensions", (*read_request.ResponseErr).Error())
		}
		return
	}
