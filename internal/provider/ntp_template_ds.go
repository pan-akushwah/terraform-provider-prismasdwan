...
// Data source.
var (
	_ datasource.DataSource              = &ntpTemplateDataSource{}
	_ datasource.DataSourceWithConfigure = &ntpTemplateDataSource{}
)
...
//	     }
//	  }
func NewNtpTemplateDataSource() datasource.DataSource {
	return &ntpTemplateDataSource{}
}

type ntpTemplateDataSource struct {
	client *sdwan.Client
}

type dsModelWithFilterNtpTemplate struct {
	...
	Items        []*dsModelNTPTemplate `tfsdk:"items"`
}

// Metadata returns the data source type name.
func (d *ntpTemplateDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_ntp_template"
}

// Schema defines the schema for this data source.
func (d *ntpTemplateDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
			...
			"items": dsschema.ListNestedAttribute{
				...
				NestedObject: dsschema.NestedAttributeObject{
					Attributes: map[string]dsschema.Attribute{
						...
						"default_template": dsschema.BoolAttribute{
							Required:  false,
							Computed:  false,
							Optional:  true,
							Sensitive: false,
...
func (d *ntpTemplateDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ntpTemplateDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterNtpTemplate
	...
	get_path := "/sdwan/v2.0/api/templates/ntp/{ntp_id}"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_ntp_template", (*list_request.ResponseErr).Error())
		}
		return
	}
	...
	for _, item := range response.Items {
		...
		// if found, exit
		if json_err != nil {
			resp.Diagnostics.AddError("error in json unmarshal to NTPTemplate", json_err.Error())
			return
		}

		// lets copy all items into state schema=NTPTemplate
