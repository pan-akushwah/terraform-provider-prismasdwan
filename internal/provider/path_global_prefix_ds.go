...
// Data source.
var (
	_ datasource.DataSource              = &pathGlobalPrefixDataSource{}
	_ datasource.DataSourceWithConfigure = &pathGlobalPrefixDataSource{}
)
...
//	     }
//	  }
func NewPathGlobalPrefixDataSource() datasource.DataSource {
	return &pathGlobalPrefixDataSource{}
}

type pathGlobalPrefixDataSource struct {
	client *sdwan.Client
}

type dsModelWithFilterPathGlobalPrefix struct {
	...
	Items        []*dsModelNetworkPolicyGlobalPrefixV2N1 `tfsdk:"items"`
}

// Metadata returns the data source type name.
func (d *pathGlobalPrefixDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_path_global_prefix"
}

// Schema defines the schema for this data source.
func (d *pathGlobalPrefixDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *pathGlobalPrefixDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *pathGlobalPrefixDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterPathGlobalPrefix
	...
	get_path := "/sdwan/v2.1/api/networkpolicyglobalprefixes/{prefix_id}"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_path_global_prefix", (*list_request.ResponseErr).Error())
		}
		return
	}
	...
	for _, item := range response.Items {
		...
		var state dsModelNetworkPolicyGlobalPrefixV2N1
		...
		// if found, exit
		if json_err != nil {
			resp.Diagnostics.AddError("error in json unmarshal to NetworkPolicyGlobalPrefixV2N1", json_err.Error())
			return
		}
