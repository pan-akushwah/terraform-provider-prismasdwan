...
// Data source.
var (
	_ datasource.DataSource              = &ipfixFilterContextDataSource{}
	_ datasource.DataSourceWithConfigure = &ipfixFilterContextDataSource{}
)
...
//	     }
//	  }
func NewIpfixFilterContextDataSource() datasource.DataSource {
	return &ipfixFilterContextDataSource{}
}

type ipfixFilterContextDataSource struct {
	client *sdwan.Client
}

type dsModelWithFilterIpfixFilterContext struct {
...
func (d *ipfixFilterContextDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_ipfix_filter_context"
}

// Schema defines the schema for this data source.
func (d *ipfixFilterContextDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *ipfixFilterContextDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *ipfixFilterContextDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterIpfixFilterContext
	...
	get_path := "/sdwan/v2.0/api/ipfixfiltercontexts/{context_id}"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_ipfix_filter_context", (*list_request.ResponseErr).Error())
		}
		return
	}
