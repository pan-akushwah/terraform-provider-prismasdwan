...
// Data source.
var (
	_ datasource.DataSource              = &siteExtensionDataSource{}
	_ datasource.DataSourceWithConfigure = &siteExtensionDataSource{}
)
...
//	     NewSiteExtensionDataSource,
//	     // -- append next datasource above -- //
//	     }
//	  }
func NewSiteExtensionDataSource() datasource.DataSource {
	return &siteExtensionDataSource{}
}

type siteExtensionDataSource struct {
	client *sdwan.Client
}

// Metadata returns the data source type name.
func (d *siteExtensionDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_site_extension"
}

// Schema defines the schema for this data source.
func (d *siteExtensionDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *siteExtensionDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *siteExtensionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if read_request.ResponseErr != nil {
		if IsObjectNotFound(*read_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_site_extension", (*read_request.ResponseErr).Error())
		}
		return
	}
