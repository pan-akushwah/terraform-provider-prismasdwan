...
// Data source.
var (
	_ datasource.DataSource              = &pathLocalPrefixDataSource{}
	_ datasource.DataSourceWithConfigure = &pathLocalPrefixDataSource{}
)
...
//	     }
//	  }
func NewPathLocalPrefixDataSource() datasource.DataSource {
	return &pathLocalPrefixDataSource{}
}

type pathLocalPrefixDataSource struct {
	client *sdwan.Client
}

type dsModelWithFilterPathLocalPrefix struct {
	...
	Items        []*dsModelNetworkPolicyLocalPrefix `tfsdk:"items"`
}

// Metadata returns the data source type name.
func (d *pathLocalPrefixDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_path_local_prefix"
}

// Schema defines the schema for this data source.
func (d *pathLocalPrefixDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *pathLocalPrefixDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *pathLocalPrefixDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterPathLocalPrefix
	...
	get_path := "/sdwan/v2.0/api/networkpolicylocalprefixes/{prefix_id}"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_path_local_prefix", (*list_request.ResponseErr).Error())
		}
		return
	}
	...
	for _, item := range response.Items {
		...
		var state dsModelNetworkPolicyLocalPrefix
		...
		// if found, exit
		if json_err != nil {
			resp.Diagnostics.AddError("error in json unmarshal to NetworkPolicyLocalPrefix", json_err.Error())
			return
		}

		// lets copy all items into state schema=NetworkPolicyLocalPrefix
