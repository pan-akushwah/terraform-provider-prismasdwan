...
func (r *newResourceLocatorResource) Configure(_ context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	resourceTypeToUrlMap["prismasdwan_elements_radii"] = "/sdwan/v2.0/api/elements/{element_id}/radii/{radius_id}"
	resourceTypeToUrlMap["prismasdwan_sites_elements_ipfix"] = "/sdwan/v2.0/api/sites/{site_id}/elements/{element_id}/ipfix/{ipfix_id}"
	resourceTypeToUrlMap["prismasdwan_sites_prismasase_connections"] = "/sdwan/v2.1/api/sites/{site_id}/prismasase_connections/{prismasase_connection_id}"
	...
	resourceTypeToUrlMap["prismasdwan_wanoverlays"] = "/sdwan/v2.0/api/wanoverlays/{wan_overlay_id}"
	...
	resourceTypeToUrlMap["prismasdwan_sites_elements_bgpconfigs"] = "/sdwan/v2.4/api/sites/{site_id}/elements/{element_id}/bgpconfigs/{bgp_config_id}"
	resourceTypeToUrlMap["prismasdwan_site_security_zone"] = "/sdwan/v2.0/api/sites/{site_id}/sitesecurityzones/{zone_id}"
	resourceTypeToUrlMap["prismasdwan_sites_elements_securityzones"] = "/sdwan/v2.0/api/sites/{site_id}/elements/{element_id}/securityzones/{security_zone_id}"
	...
	resourceTypeToUrlMap["prismasdwan_sites_elements_interfaces"] = "/sdwan/v4.20/api/sites/{site_id}/elements/{element_id}/interfaces/{interface_id}"
	...
	resourceTypeToUrlMap["prismasdwan_eventcorrelationpolicysets_eventcorrelationpolicyrules"] = "/sdwan/v2.1/api/eventcorrelationpolicysets/{policy_set_id}/eventcorrelationpolicyrules/{policy_rule_id}"
	resourceTypeToUrlMap["prismasdwan_sites_pathprefixdistributionfilterassociation"] = "/sdwan/v2.0/api/sites/{site_id}/pathprefixdistributionfilterassociation/{id}"
	...
	resourceTypeToUrlMap["prismasdwan_ipsecprofiles"] = "/sdwan/v2.2/api/ipsecprofiles/{profile_id}"
	...
	resourceTypeToUrlMap["prismasdwan_sites_prefixfilters"] = "/sdwan/v2.0/api/sites/{site_id}/prefixfilters/{filter_id}"
	...
	resourceTypeToUrlMap["prismasdwan_sites_elements_dnsservices"] = "/sdwan/v2.0/api/sites/{site_id}/elements/{element_id}/dnsservices/{dnsservice_role_id}"
	...
	resourceTypeToUrlMap["prismasdwan_users"] = "/sdwan/v2.0/api/users/{user_id}"
	...
	resourceTypeToUrlMap["prismasdwan_sites_prioritypolicylocalprefixes"] = "/sdwan/v2.1/api/sites/{site_id}/prioritypolicylocalprefixes/{prefix_id}"
	...
	resourceTypeToUrlMap["prismasdwan_useridagents"] = "/sdwan/v2.0/api/useridagents/{id}"
	resourceTypeToUrlMap["prismasdwan_elements_ntp"] = "/sdwan/v2.1/api/elements/{element_id}/ntp/{ntp_id}"
	...
	resourceTypeToUrlMap["prismasdwan_sites_elements_ospfglobalconfigs"] = "/sdwan/v2.0/api/sites/{site_id}/elements/{element_id}/ospfglobalconfigs/{ospf_config_id}"
	...
	resourceTypeToUrlMap["prismasdwan_vfflicenses_tokens"] = "/sdwan/v2.0/api/vfflicenses/{license_id}/tokens/{token_id}"
	resourceTypeToUrlMap["prismasdwan_security_policy_global_prefix"] = "/sdwan/v2.1/api/ngfwsecuritypolicyglobalprefixes/{prefix_id}"
	resourceTypeToUrlMap["prismasdwan_sites_elements_extensions"] = "/sdwan/v2.0/api/sites/{site_id}/elements/{element_id}/extensions/{extension_id}"
	...
	resourceTypeToUrlMap["prismasdwan_sites_elements_bgppeers"] = "/sdwan/v2.6/api/sites/{site_id}/elements/{element_id}/bgppeers/{bgp_peer_id}"
	...
	resourceTypeToUrlMap["prismasdwan_externalcaconfigs"] = "/sdwan/v2.0/api/externalcaconfigs/{id}"
	...
	resourceTypeToUrlMap["prismasdwan_sdwanapps_configs"] = "/sdwan/v2.0/api/sdwanapps/{app_id}/configs/{cid}"
	resourceTypeToUrlMap["prismasdwan_sites_hubclusters"] = "/sdwan/v4.0/api/sites/{site_id}/hubclusters/{hub_cluster_id}"
	resourceTypeToUrlMap["prismasdwan_sites_prismaaccess_configs"] = "/sdwan/v2.0/api/sites/{site_id}/prismaaccess_configs/{config_id}"
	...
	resourceTypeToUrlMap["prismasdwan_elementusers_access"] = "/sdwan/v2.1/api/elementusers/{user_id}/access/{access_id}"
	...
	resourceTypeToUrlMap["prismasdwan_sites_hubclusters_hubclustermembers"] = "/sdwan/v3.0/api/sites/{site_id}/hubclusters/{hub_cluster_id}/hubclustermembers/{hub_cluster_member_id}"
	...
	resourceTypeToUrlMap["prismasdwan_probeprofiles"] = "/sdwan/v2.0/api/probeprofiles/{profile_id}"
	resourceTypeToUrlMap["prismasdwan_sites_elements_mstp_instances"] = "/sdwan/v2.0/api/sites/{site_id}/elements/{element_id}/mstp_instances/{mstp_instance_id}"
	resourceTypeToUrlMap["prismasdwan_localprefixfilters"] = "/sdwan/v2.0/api/localprefixfilters/{id}"
	...
	resourceTypeToUrlMap["prismasdwan_elementusers"] = "/sdwan/v2.1/api/elementusers/{user_id}"
	...
	resourceTypeToUrlMap["prismasdwan_elements_cellular_modules"] = "/sdwan/v2.0/api/elements/{element_id}/cellular_modules/{cellular_module_id}"
	resourceTypeToUrlMap["prismasdwan_sites_elements_multicastglobalconfigs"] = "/sdwan/v2.1/api/sites/{site_id}/elements/{element_id}/multicastglobalconfigs/{config_id}"
	...
	resourceTypeToUrlMap["prismasdwan_sites_elements_tacacs_plus_servers"] = "/sdwan/v2.0/api/sites/{site_id}/elements/{element_id}/tacacs_plus_servers/{id}"
	resourceTypeToUrlMap["prismasdwan_domain"] = "/sdwan/v2.1/api/servicebindingmaps/{map_id}"
	resourceTypeToUrlMap["prismasdwan_sites_extensions"] = "/sdwan/v2.0/api/sites/{site_id}/extensions/{extension_id}"
	...
	resourceTypeToUrlMap["prismasdwan_elements_cellular_modules_sim_security"] = "/sdwan/v2.0/api/elements/{element_id}/cellular_modules/{cellular_module_id}/sim_security/{sim_security_id}"
	...
	resourceTypeToUrlMap["prismasdwan_eventcorrelationpolicysets"] = "/sdwan/v2.0/api/eventcorrelationpolicysets/{policy_set_id}"
	resourceTypeToUrlMap["prismasdwan_probeconfigs"] = "/sdwan/v2.0/api/probeconfigs/{config_id}"
	resourceTypeToUrlMap["prismasdwan_pathgroups"] = "/sdwan/v2.1/api/pathgroups/{path_group_id}"
