...
// Data source.
var (
	_ datasource.DataSource              = &siteCiphersDataSource{}
	_ datasource.DataSourceWithConfigure = &siteCiphersDataSource{}
)
...
//	     }
//	  }
func NewSiteCiphersDataSource() datasource.DataSource {
	return &siteCiphersDataSource{}
}

type siteCiphersDataSource struct {
	client *sdwan.Client
}
...
func (d *siteCiphersDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *siteCiphersDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *siteCiphersDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterSiteCiphers
	...
	get_path := "/sdwan/v2.0/api/sites/{site_id}/siteciphers"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_site_ciphers", (*list_request.ResponseErr).Error())
		}
		return
	}
