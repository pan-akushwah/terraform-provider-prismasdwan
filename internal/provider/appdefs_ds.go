...
// Data source.
var (
	_ datasource.DataSource              = &appdefsDataSource{}
	_ datasource.DataSourceWithConfigure = &appdefsDataSource{}
)
...
//	     NewAppdefsDataSource,
//	     // -- append next datasource above -- //
//	     }
//	  }
func NewAppdefsDataSource() datasource.DataSource {
	return &appdefsDataSource{}
}

type appdefsDataSource struct {
	client *sdwan.Client
}

// Metadata returns the data source type name.
func (d *appdefsDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_appdefs"
}

// Schema defines the schema for this data source.
func (d *appdefsDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *appdefsDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *appdefsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if read_request.ResponseErr != nil {
		if IsObjectNotFound(*read_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_appdefs", (*read_request.ResponseErr).Error())
		}
		return
	}
