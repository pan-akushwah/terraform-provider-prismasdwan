		...
		if ans.ServiceLinkConfig.IpsecConfig == nil {
			...
			if ans.ServiceLinkConfig.IpsecConfig.Authentication == nil {
				...
				if ans.ServiceLinkConfig.IpsecConfig.Authentication.X509objects == nil {
					...
					state.ServiceLinkConfig.IpsecConfig.Authentication.X509objects = &dsModelX509Objects{}
					// copy_to_state: state=state.ServiceLinkConfig.IpsecConfig.Authentication.X509objects prefix=dsModel ans=ans.ServiceLinkConfig.IpsecConfig.Authentication.X509objects properties=12
