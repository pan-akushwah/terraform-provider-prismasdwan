...
// Data source.
var (
	_ datasource.DataSource              = &elementBgpConfigDataSource{}
	_ datasource.DataSourceWithConfigure = &elementBgpConfigDataSource{}
)
...
//	     }
//	  }
func NewElementBgpConfigDataSource() datasource.DataSource {
	return &elementBgpConfigDataSource{}
}

type elementBgpConfigDataSource struct {
	client *sdwan.Client
}

type dsModelWithFilterElementBgpConfig struct {
...
func (d *elementBgpConfigDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *elementBgpConfigDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *elementBgpConfigDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterElementBgpConfig
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_element_bgp_config", (*list_request.ResponseErr).Error())
		}
		return
	}
