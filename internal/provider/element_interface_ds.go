...
type dsModelWithFilterElementInterface struct {
...
func (d *elementInterfaceDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var state_with_filter dsModelWithFilterElementInterface
	...
	get_path := "/sdwan/v4.21/api/sites/{site_id}/elements/{element_id}/interfaces/{interface_id}"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_element_interface", (*list_request.ResponseErr).Error())
		}
		return
	}
