...
// Data source.
var (
	_ datasource.DataSource              = &qosPolicyLocalPrefixDataSource{}
	_ datasource.DataSourceWithConfigure = &qosPolicyLocalPrefixDataSource{}
)
...
//	     }
//	  }
func NewQosPolicyLocalPrefixDataSource() datasource.DataSource {
	return &qosPolicyLocalPrefixDataSource{}
}

type qosPolicyLocalPrefixDataSource struct {
	client *sdwan.Client
}

type dsModelWithFilterQosPolicyLocalPrefix struct {
	...
	Items        []*dsModelPriorityPolicyLocalPrefix `tfsdk:"items"`
}

// Metadata returns the data source type name.
func (d *qosPolicyLocalPrefixDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_qos_policy_local_prefix"
}

// Schema defines the schema for this data source.
func (d *qosPolicyLocalPrefixDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *qosPolicyLocalPrefixDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *qosPolicyLocalPrefixDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterQosPolicyLocalPrefix
	...
	get_path := "/sdwan/v2.0/api/prioritypolicylocalprefixes/{priority_policy_id}"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_qos_policy_local_prefix", (*list_request.ResponseErr).Error())
		}
		return
	}
	...
	for _, item := range response.Items {
		...
		var state dsModelPriorityPolicyLocalPrefix
		...
		// if found, exit
		if json_err != nil {
			resp.Diagnostics.AddError("error in json unmarshal to PriorityPolicyLocalPrefix", json_err.Error())
			return
		}
