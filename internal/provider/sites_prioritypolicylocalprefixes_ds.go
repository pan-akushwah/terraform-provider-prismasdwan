...
// Data source.
var (
	_ datasource.DataSource              = &sitesPrioritypolicylocalprefixesDataSource{}
	_ datasource.DataSourceWithConfigure = &sitesPrioritypolicylocalprefixesDataSource{}
)
...
//	     NewSitesPrioritypolicylocalprefixesDataSource,
//	     // -- append next datasource above -- //
//	     }
//	  }
func NewSitesPrioritypolicylocalprefixesDataSource() datasource.DataSource {
	return &sitesPrioritypolicylocalprefixesDataSource{}
}

type sitesPrioritypolicylocalprefixesDataSource struct {
	client *sdwan.Client
}

// Metadata returns the data source type name.
func (d *sitesPrioritypolicylocalprefixesDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_sites_prioritypolicylocalprefixes"
}

// Schema defines the schema for this data source.
func (d *sitesPrioritypolicylocalprefixesDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *sitesPrioritypolicylocalprefixesDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *sitesPrioritypolicylocalprefixesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if read_request.ResponseErr != nil {
		if IsObjectNotFound(*read_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_sites_prioritypolicylocalprefixes", (*read_request.ResponseErr).Error())
		}
		return
	}
