...
// Data source.
var (
	_ datasource.DataSource              = &sdwanappsConfigDataSource{}
	_ datasource.DataSourceWithConfigure = &sdwanappsConfigDataSource{}
)
...
//	     }
//	  }
func NewSdwanappsConfigDataSource() datasource.DataSource {
	return &sdwanappsConfigDataSource{}
}

type sdwanappsConfigDataSource struct {
	client *sdwan.Client
}

type dsModelWithFilterSdwanappsConfig struct {
	...
	Items        []*dsModelSDWANAppConfigScreen `tfsdk:"items"`
}

// Metadata returns the data source type name.
func (d *sdwanappsConfigDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *sdwanappsConfigDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *sdwanappsConfigDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterSdwanappsConfig
	...
	get_path := "/sdwan/v2.0/api/sdwanapps/{app_id}/configs/{cid}"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_sdwanapps_config", (*list_request.ResponseErr).Error())
		}
		return
	}
