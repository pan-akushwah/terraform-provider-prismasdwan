...
func (d *usersDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = dsschema.Schema{
		...
		Attributes: map[string]dsschema.Attribute{
			...
			"middle_name": dsschema.StringAttribute{
				Required:  false,
				Computed:  false,
				Optional:  true,
				Sensitive: false,
			...
			"user_dn": dsschema.StringAttribute{
				Required:  false,
				Computed:  false,
				Optional:  true,
				Sensitive: false,
			...
			"user_fqn": dsschema.StringAttribute{
				Required:  false,
				Computed:  false,
				Optional:  true,
				Sensitive: false,
...
func (d *usersDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if read_request.ResponseErr != nil {
		if IsObjectNotFound(*read_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_users", (*read_request.ResponseErr).Error())
		}
		return
	}
	...
	// if found, exit
	if json_err != nil {
		resp.Diagnostics.AddError("error in json unmarshal to UserIdentity", json_err.Error())
		return
	}

	// lets copy all items into state schema=UserIdentity
