...
// Data source.
var (
	_ datasource.DataSource              = &qosPolicyGlobalPrefixDataSource{}
	_ datasource.DataSourceWithConfigure = &qosPolicyGlobalPrefixDataSource{}
)
...
//	     }
//	  }
func NewQosPolicyGlobalPrefixDataSource() datasource.DataSource {
	return &qosPolicyGlobalPrefixDataSource{}
}

type qosPolicyGlobalPrefixDataSource struct {
	client *sdwan.Client
}

type dsModelWithFilterQosPolicyGlobalPrefix struct {
	...
	Items        []*dsModelPriorityPolicyGlobalPrefixV2N1 `tfsdk:"items"`
}

// Metadata returns the data source type name.
func (d *qosPolicyGlobalPrefixDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_qos_policy_global_prefix"
}

// Schema defines the schema for this data source.
func (d *qosPolicyGlobalPrefixDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *qosPolicyGlobalPrefixDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *qosPolicyGlobalPrefixDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterQosPolicyGlobalPrefix
	...
	get_path := "/sdwan/v2.1/api/prioritypolicyglobalprefixes/{priority_policy_id}"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_qos_policy_global_prefix", (*list_request.ResponseErr).Error())
		}
		return
	}
	...
	for _, item := range response.Items {
		...
		var state dsModelPriorityPolicyGlobalPrefixV2N1
		...
		// if found, exit
		if json_err != nil {
			resp.Diagnostics.AddError("error in json unmarshal to PriorityPolicyGlobalPrefixV2N1", json_err.Error())
			return
		}

		// lets copy all items into state schema=PriorityPolicyGlobalPrefixV2N1
