...
type dsModelWithFilterDomain struct {
	...
	Items        []*dsModelServiceBindingMapScreenV2N1 `tfsdk:"items"`
}
...
func (d *domainDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var state_with_filter dsModelWithFilterDomain
	...
	get_path := "/sdwan/v2.1/api/servicebindingmaps/{map_id}"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_domain", (*list_request.ResponseErr).Error())
		}
		return
	}
