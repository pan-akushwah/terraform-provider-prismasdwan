...
// Data source.
var (
	_ datasource.DataSource              = &siteSecurityZoneDataSource{}
	_ datasource.DataSourceWithConfigure = &siteSecurityZoneDataSource{}
)
...
//	     }
//	  }
func NewSiteSecurityZoneDataSource() datasource.DataSource {
	return &siteSecurityZoneDataSource{}
}

type siteSecurityZoneDataSource struct {
	client *sdwan.Client
}
...
func (d *siteSecurityZoneDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
...
func (d *siteSecurityZoneDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *siteSecurityZoneDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterSiteSecurityZone
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_site_security_zone", (*list_request.ResponseErr).Error())
		}
		return
	}
