...
type dsModelWithFilterPerformancePolicySet struct {
	...
	Items        []*dsModelPerfMgmtPolicySet `tfsdk:"items"`
}
...
func (d *performancePolicySetDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var state_with_filter dsModelWithFilterPerformancePolicySet
	...
	get_path := "/sdwan/v2.0/api/perfmgmtpolicysets/{perfmgmtpolicyset_id}"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_performance_policy_set", (*list_request.ResponseErr).Error())
		}
		return
	}
