...
// Data source.
var (
	_ datasource.DataSource              = &elementExtensionDataSource{}
	_ datasource.DataSourceWithConfigure = &elementExtensionDataSource{}
)
...
//	     NewElementExtensionDataSource,
//	     // -- append next datasource above -- //
//	     }
//	  }
func NewElementExtensionDataSource() datasource.DataSource {
	return &elementExtensionDataSource{}
}

type elementExtensionDataSource struct {
	client *sdwan.Client
}

// Metadata returns the data source type name.
func (d *elementExtensionDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_element_extension"
}

// Schema defines the schema for this data source.
func (d *elementExtensionDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *elementExtensionDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *elementExtensionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if read_request.ResponseErr != nil {
		if IsObjectNotFound(*read_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_element_extension", (*read_request.ResponseErr).Error())
		}
		return
	}
