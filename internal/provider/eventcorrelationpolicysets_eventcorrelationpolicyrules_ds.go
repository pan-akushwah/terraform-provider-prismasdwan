...
// Data source.
var (
	_ datasource.DataSource              = &eventcorrelationpolicysetsEventcorrelationpolicyrulesDataSource{}
	_ datasource.DataSourceWithConfigure = &eventcorrelationpolicysetsEventcorrelationpolicyrulesDataSource{}
)
...
//	     NewEventcorrelationpolicysetsEventcorrelationpolicyrulesDataSource,
//	     // -- append next datasource above -- //
//	     }
//	  }
func NewEventcorrelationpolicysetsEventcorrelationpolicyrulesDataSource() datasource.DataSource {
	return &eventcorrelationpolicysetsEventcorrelationpolicyrulesDataSource{}
}

type eventcorrelationpolicysetsEventcorrelationpolicyrulesDataSource struct {
	client *sdwan.Client
}

// Metadata returns the data source type name.
func (d *eventcorrelationpolicysetsEventcorrelationpolicyrulesDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_eventcorrelationpolicysets_eventcorrelationpolicyrules"
}

// Schema defines the schema for this data source.
func (d *eventcorrelationpolicysetsEventcorrelationpolicyrulesDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *eventcorrelationpolicysetsEventcorrelationpolicyrulesDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *eventcorrelationpolicysetsEventcorrelationpolicyrulesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if read_request.ResponseErr != nil {
		if IsObjectNotFound(*read_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_eventcorrelationpolicysets_eventcorrelationpolicyrules", (*read_request.ResponseErr).Error())
		}
		return
	}
