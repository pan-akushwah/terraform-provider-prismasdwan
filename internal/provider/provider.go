...
func (p *SdwanProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewGlobalPrefixFilterDataSource,
		NewIotProfileDataSource,
		NewIpfixCollectorContextDataSource,
		NewIpfixFilterContextDataSource,
		NewIpfixGlobalPrefixDataSource,
		NewIpfixLocalPrefixDataSource,
		NewIpfixProfileDataSource,
		NewIpfixTemplateDataSource,
		NewIpsecProfileDataSource,
		NewLocalPrefixFilterDataSource,
		NewMulticastPeerGroupProfileDataSource,
		NewNatGlobalPrefixDataSource,
		NewNatLocalPrefixDataSource,
		NewNatPolicyPoolDataSource,
		NewNatPolicyRuleDataSource,
		NewNatPolicySetDataSource,
		NewNatPolicySetStackDataSource,
		NewNatZoneDataSource,
		NewNetworkContextDataSource,
		NewNtpTemplateDataSource,
		NewPathGlobalPrefixDataSource,
		NewPathGroupDataSource,
		NewPathLocalPrefixDataSource,
		...
		NewProbeProfileDataSource,
		NewQosPolicyGlobalPrefixDataSource,
		NewQosPolicyLocalPrefixDataSource,
		NewQosPolicyRuleDataSource,
		NewQosPolicySetDataSource,
		NewQosPolicyStackDataSource,
		NewSdwanappsConfigDataSource,
		NewSecurityPolicyGlobalPrefixDataSource,
		NewSecurityPolicyLocalPrefixDataSource,
		NewSecurityPolicyRuleDataSource,
		NewSecurityPolicySetDataSource,
		NewSecurityPolicyStackDataSource,
		NewSecurityZoneDataSource,
		NewServiceEndpointDataSource,
		NewServiceGroupDataSource,
		NewSiteCiphersDataSource,
		NewSiteDataSource,
		NewSiteDhcpServerDataSource,
		NewSiteHubClusterDataSource,
		NewSiteHubClusterMemberDataSource,
		NewSiteHubDistributionFabricDataSource,
		NewSiteHubPrefixFilterAssociationDataSource,
		NewSiteHubPrefixFilterDataSource,
		NewSiteHubPrefixFilterProfileDataSource,
		NewSiteIotDeviceIdConfigDataSource,
		NewSiteIotSnmpStartNodeDataSource,
		NewSiteIpfixLocalPrefixDataSource,
		NewSiteLanNetworkDataSource,
		NewSiteNatLocalPrefixDataSource,
		NewSitePathPolicyLocalPrefixDataSource,
		NewSitePrismaAccessConfigDataSource,
		NewSitePrismaSaseConnectionDataSource,
		NewSiteQosPolicyLocalPrefixDataSource,
		NewSiteSecurityPolicyLocalPrefixDataSource,
		NewSiteSecurityZoneDataSource,
		NewSiteSpokeClusterDataSource,
