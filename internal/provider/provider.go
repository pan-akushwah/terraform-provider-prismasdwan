...
func (p *SdwanProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewEventcorrelationpolicysetsEventcorrelationpolicyrulesResource,
		NewEventcorrelationpolicysetsResource,
		NewExternalcaconfigsResource,
		...
		NewIpsecprofilesResource,
		NewLocalprefixfiltersResource,
