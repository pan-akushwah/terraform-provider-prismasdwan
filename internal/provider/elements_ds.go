...
// Data source.
var (
	_ datasource.DataSource              = &elementsDataSource{}
	_ datasource.DataSourceWithConfigure = &elementsDataSource{}
)
...
//	     NewElementsDataSource,
//	     // -- append next datasource above -- //
//	     }
//	  }
func NewElementsDataSource() datasource.DataSource {
	return &elementsDataSource{}
}

type elementsDataSource struct {
	client *sdwan.Client
}

// Metadata returns the data source type name.
func (d *elementsDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_elements"
}

// Schema defines the schema for this data source.
func (d *elementsDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = dsschema.Schema{
		...
		Attributes: map[string]dsschema.Attribute{
			...
			"admin_action": dsschema.StringAttribute{
				Required:  false,
				Computed:  false,
				Optional:  true,
				Sensitive: false,
			...
			"admin_renew_state": dsschema.StringAttribute{
				Required:  false,
				Computed:  false,
				Optional:  true,
				Sensitive: false,
			...
			"admin_suspend_state": dsschema.StringAttribute{
				Required:  false,
				Computed:  false,
				Optional:  true,
				Sensitive: false,
			...
			"connected": dsschema.BoolAttribute{
				Required:  false,
				Computed:  false,
				Optional:  true,
				Sensitive: false,
			...
			"deployment_op": dsschema.StringAttribute{
				Required:  false,
				Computed:  false,
				Optional:  true,
				Sensitive: false,
			...
			"device_change_mode_start_time": dsschema.Int64Attribute{
				Required:  false,
				Computed:  false,
				Optional:  true,
				Sensitive: false,
			...
			"device_change_mode_state": dsschema.StringAttribute{
				Required:  false,
				Computed:  false,
				Optional:  true,
				Sensitive: false,
			...
			"fips_mode": dsschema.StringAttribute{
				Required:  false,
				Computed:  false,
				Optional:  true,
				Sensitive: false,
			...
			"fips_mode_change_start_time": dsschema.Int64Attribute{
				Required:  false,
				Computed:  false,
				Optional:  true,
				Sensitive: false,
...
func (d *elementsDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *elementsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var state dsModelElementV3N2
	...
	if read_request.ResponseErr != nil {
		if IsObjectNotFound(*read_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_elements", (*read_request.ResponseErr).Error())
		}
		return
	}
	...
	// if found, exit
	if json_err != nil {
		resp.Diagnostics.AddError("error in json unmarshal to ElementV3N2", json_err.Error())
		return
	}

	// lets copy all items into state schema=ElementV3N2
	// copy_to_state: state=state prefix=dsModel ans=ans properties=38
