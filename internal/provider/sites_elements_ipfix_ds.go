...
// Data source.
var (
	_ datasource.DataSource              = &sitesElementsIpfixDataSource{}
	_ datasource.DataSourceWithConfigure = &sitesElementsIpfixDataSource{}
)
...
//	     NewSitesElementsIpfixDataSource,
//	     // -- append next datasource above -- //
//	     }
//	  }
func NewSitesElementsIpfixDataSource() datasource.DataSource {
	return &sitesElementsIpfixDataSource{}
}

type sitesElementsIpfixDataSource struct {
	client *sdwan.Client
}

// Metadata returns the data source type name.
func (d *sitesElementsIpfixDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_sites_elements_ipfix"
}

// Schema defines the schema for this data source.
func (d *sitesElementsIpfixDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *sitesElementsIpfixDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *sitesElementsIpfixDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if read_request.ResponseErr != nil {
		if IsObjectNotFound(*read_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_sites_elements_ipfix", (*read_request.ResponseErr).Error())
		}
		return
	}
