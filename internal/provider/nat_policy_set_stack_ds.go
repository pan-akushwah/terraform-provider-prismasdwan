...
// Data source.
var (
	_ datasource.DataSource              = &natPolicySetStackDataSource{}
	_ datasource.DataSourceWithConfigure = &natPolicySetStackDataSource{}
)
...
//	     }
//	  }
func NewNatPolicySetStackDataSource() datasource.DataSource {
	return &natPolicySetStackDataSource{}
}

type natPolicySetStackDataSource struct {
	client *sdwan.Client
}

type dsModelWithFilterNatPolicySetStack struct {
	...
	Items        []*dsModelNATPolicySetStackPOSTScreen `tfsdk:"items"`
}

// Metadata returns the data source type name.
func (d *natPolicySetStackDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_nat_policy_set_stack"
}

// Schema defines the schema for this data source.
func (d *natPolicySetStackDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *natPolicySetStackDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *natPolicySetStackDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterNatPolicySetStack
	...
	get_path := "/sdwan/v2.0/api/natpolicysetstacks/{natpolicy_set_stack_id}"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_nat_policy_set_stack", (*list_request.ResponseErr).Error())
		}
		return
	}
	...
	for _, item := range response.Items {
		...
		var state dsModelNATPolicySetStackPOSTScreen
		...
		// if found, exit
		if json_err != nil {
			resp.Diagnostics.AddError("error in json unmarshal to NATPolicySetStackPOSTScreen", json_err.Error())
			return
		}
