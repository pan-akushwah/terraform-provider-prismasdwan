...
// Data source.
var (
	_ datasource.DataSource              = &sitesElementsSecurityzonesDataSource{}
	_ datasource.DataSourceWithConfigure = &sitesElementsSecurityzonesDataSource{}
)
...
//	     NewSitesElementsSecurityzonesDataSource,
//	     // -- append next datasource above -- //
//	     }
//	  }
func NewSitesElementsSecurityzonesDataSource() datasource.DataSource {
	return &sitesElementsSecurityzonesDataSource{}
}

type sitesElementsSecurityzonesDataSource struct {
	client *sdwan.Client
}

// Metadata returns the data source type name.
func (d *sitesElementsSecurityzonesDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_sites_elements_securityzones"
}

// Schema defines the schema for this data source.
func (d *sitesElementsSecurityzonesDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *sitesElementsSecurityzonesDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *sitesElementsSecurityzonesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if read_request.ResponseErr != nil {
		if IsObjectNotFound(*read_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_sites_elements_securityzones", (*read_request.ResponseErr).Error())
		}
		return
	}
