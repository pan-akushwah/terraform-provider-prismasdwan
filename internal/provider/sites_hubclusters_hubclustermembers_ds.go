...
// Data source.
var (
	_ datasource.DataSource              = &sitesHubclustersHubclustermembersDataSource{}
	_ datasource.DataSourceWithConfigure = &sitesHubclustersHubclustermembersDataSource{}
)
...
//	     NewSitesHubclustersHubclustermembersDataSource,
//	     // -- append next datasource above -- //
//	     }
//	  }
func NewSitesHubclustersHubclustermembersDataSource() datasource.DataSource {
	return &sitesHubclustersHubclustermembersDataSource{}
}

type sitesHubclustersHubclustermembersDataSource struct {
	client *sdwan.Client
}

// Metadata returns the data source type name.
func (d *sitesHubclustersHubclustermembersDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_sites_hubclusters_hubclustermembers"
}

// Schema defines the schema for this data source.
func (d *sitesHubclustersHubclustermembersDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *sitesHubclustersHubclustermembersDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *sitesHubclustersHubclustermembersDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if read_request.ResponseErr != nil {
		if IsObjectNotFound(*read_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_sites_hubclusters_hubclustermembers", (*read_request.ResponseErr).Error())
		}
		return
	}
