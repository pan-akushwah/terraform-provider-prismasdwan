...
type dsModelWithFilterPerformancePolicyStack struct {
	...
	Items        []*dsModelPerfMgmtPolicySetStack `tfsdk:"items"`
}
...
func (d *performancePolicyStackDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var state_with_filter dsModelWithFilterPerformancePolicyStack
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_performance_policy_stack", (*list_request.ResponseErr).Error())
		}
		return
	}
