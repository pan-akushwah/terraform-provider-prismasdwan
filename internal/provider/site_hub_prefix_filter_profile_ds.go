...
type dsModelWithFilterSiteHubPrefixFilterProfile struct {
	...
	Items        []*dsModelPathPrefixDistributionFilters `tfsdk:"items"`
}
...
func (d *siteHubPrefixFilterProfileDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var state_with_filter dsModelWithFilterSiteHubPrefixFilterProfile
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_site_hub_prefix_filter_profile", (*list_request.ResponseErr).Error())
		}
		return
	}
