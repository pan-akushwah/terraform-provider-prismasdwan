...
// Data source.
var (
	_ datasource.DataSource              = &appdefsOverridesDataSource{}
	_ datasource.DataSourceWithConfigure = &appdefsOverridesDataSource{}
)
...
//	     NewAppdefsOverridesDataSource,
//	     // -- append next datasource above -- //
//	     }
//	  }
func NewAppdefsOverridesDataSource() datasource.DataSource {
	return &appdefsOverridesDataSource{}
}

type appdefsOverridesDataSource struct {
	client *sdwan.Client
}

// Metadata returns the data source type name.
func (d *appdefsOverridesDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_appdefs_overrides"
}

// Schema defines the schema for this data source.
func (d *appdefsOverridesDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *appdefsOverridesDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *appdefsOverridesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if read_request.ResponseErr != nil {
		if IsObjectNotFound(*read_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_appdefs_overrides", (*read_request.ResponseErr).Error())
		}
		return
	}
