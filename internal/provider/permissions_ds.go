...
func (d *permissionsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var state dsModelCustomPermission
	...
	if read_request.ResponseErr != nil {
		if IsObjectNotFound(*read_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_permissions", (*read_request.ResponseErr).Error())
		}
		return
	}
	...
	// if found, exit
	if json_err != nil {
		resp.Diagnostics.AddError("error in json unmarshal to CustomPermission", json_err.Error())
		return
	}

	// lets copy all items into state schema=CustomPermission
