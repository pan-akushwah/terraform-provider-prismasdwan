...
// Data source.
var (
	_ datasource.DataSource              = &vffLicenseTokenDataSource{}
	_ datasource.DataSourceWithConfigure = &vffLicenseTokenDataSource{}
)
...
//	     NewVffLicenseTokenDataSource,
//	     // -- append next datasource above -- //
//	     }
//	  }
func NewVffLicenseTokenDataSource() datasource.DataSource {
	return &vffLicenseTokenDataSource{}
}

type vffLicenseTokenDataSource struct {
	client *sdwan.Client
}

// Metadata returns the data source type name.
func (d *vffLicenseTokenDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_vff_license_token"
}

// Schema defines the schema for this data source.
func (d *vffLicenseTokenDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = dsschema.Schema{
		...
		Attributes: map[string]dsschema.Attribute{
			...
			"ion_key": dsschema.StringAttribute{
				Required:  false,
				Computed:  false,
				Optional:  true,
				Sensitive: false,
			...
			"is_multiuse": dsschema.BoolAttribute{
				Required:  false,
				Computed:  false,
				Optional:  true,
				Sensitive: false,
			...
			"is_revoked": dsschema.BoolAttribute{
				Required:  false,
				Computed:  false,
				Optional:  true,
				Sensitive: false,
			...
			"is_used": dsschema.BoolAttribute{
				Required:  false,
				Computed:  false,
				Optional:  true,
				Sensitive: false,
			...
			"secret_key": dsschema.StringAttribute{
				Required:  false,
				Computed:  false,
				Optional:  true,
				Sensitive: true,
			...
			"secret_key_internal_key_name": dsschema.StringAttribute{
				Required:  false,
				Computed:  true,
				Optional:  true,
				Sensitive: false,
			...
			"valid_till_secs": dsschema.Int64Attribute{
				Required:  false,
				Computed:  false,
				Optional:  true,
				Sensitive: false,
			...
			"vfflicense_id": dsschema.StringAttribute{
				Required:  false,
				Computed:  false,
				Optional:  true,
				Sensitive: false,
...
func (d *vffLicenseTokenDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *vffLicenseTokenDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var state dsModelVffTokenScreen
	...
	params["license_id"] = &tokens[0]
	params["token_id"] = &tokens[1]
	...
	if read_request.ResponseErr != nil {
		if IsObjectNotFound(*read_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_vff_license_token", (*read_request.ResponseErr).Error())
		}
		return
	}
	...
	// if found, exit
	if json_err != nil {
		resp.Diagnostics.AddError("error in json unmarshal to VffTokenScreen", json_err.Error())
		return
	}

	// lets copy all items into state schema=VffTokenScreen
	...
	state.SecretKey = types.StringPointerValue(ans.SecretKey)
