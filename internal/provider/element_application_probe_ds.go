...
// Data source.
var (
	_ datasource.DataSource              = &elementApplicationProbeDataSource{}
	_ datasource.DataSourceWithConfigure = &elementApplicationProbeDataSource{}
)
...
//	     }
//	  }
func NewElementApplicationProbeDataSource() datasource.DataSource {
	return &elementApplicationProbeDataSource{}
}

type elementApplicationProbeDataSource struct {
	client *sdwan.Client
}

type dsModelWithFilterElementApplicationProbe struct {
	...
	Items        []*dsModelApplicationProbeScreen `tfsdk:"items"`
}

// Metadata returns the data source type name.
func (d *elementApplicationProbeDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_element_application_probe"
}

// Schema defines the schema for this data source.
func (d *elementApplicationProbeDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
			...
			"items": dsschema.ListNestedAttribute{
				...
				NestedObject: dsschema.NestedAttributeObject{
					Attributes: map[string]dsschema.Attribute{
						...
						"enable_probe": dsschema.BoolAttribute{
							Required:  false,
							Computed:  false,
							Optional:  true,
							Sensitive: false,
...
func (d *elementApplicationProbeDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *elementApplicationProbeDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterElementApplicationProbe
	...
	get_path := "/sdwan/v2.0/api/sites/{site_id}/elements/{element_id}/application_probe"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_element_application_probe", (*list_request.ResponseErr).Error())
		}
		return
	}
	...
	for _, item := range response.Items {
		...
		var state dsModelApplicationProbeScreen
		...
		// if found, exit
		if json_err != nil {
			resp.Diagnostics.AddError("error in json unmarshal to ApplicationProbeScreen", json_err.Error())
			return
		}
