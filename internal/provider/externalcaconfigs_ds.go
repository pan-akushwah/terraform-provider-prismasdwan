...
// Data source.
var (
	_ datasource.DataSource              = &externalcaconfigsDataSource{}
	_ datasource.DataSourceWithConfigure = &externalcaconfigsDataSource{}
)
...
//	     NewExternalcaconfigsDataSource,
//	     // -- append next datasource above -- //
//	     }
//	  }
func NewExternalcaconfigsDataSource() datasource.DataSource {
	return &externalcaconfigsDataSource{}
}

type externalcaconfigsDataSource struct {
	client *sdwan.Client
}

// Metadata returns the data source type name.
func (d *externalcaconfigsDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_externalcaconfigs"
}

// Schema defines the schema for this data source.
func (d *externalcaconfigsDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *externalcaconfigsDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *externalcaconfigsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if read_request.ResponseErr != nil {
		if IsObjectNotFound(*read_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_externalcaconfigs", (*read_request.ResponseErr).Error())
		}
		return
	}
