...
// Data source.
var (
	_ datasource.DataSource              = &siteSecurityPolicyLocalPrefixDataSource{}
	_ datasource.DataSourceWithConfigure = &siteSecurityPolicyLocalPrefixDataSource{}
)
...
//	     }
//	  }
func NewSiteSecurityPolicyLocalPrefixDataSource() datasource.DataSource {
	return &siteSecurityPolicyLocalPrefixDataSource{}
}

type siteSecurityPolicyLocalPrefixDataSource struct {
	client *sdwan.Client
}

type dsModelWithFilterSiteSecurityPolicyLocalPrefix struct {
	...
	Items        []*dsModelSiteSecurityPolicyV2N1PrefixAssociationScreen `tfsdk:"items"`
}

// Metadata returns the data source type name.
func (d *siteSecurityPolicyLocalPrefixDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_site_security_policy_local_prefix"
}

// Schema defines the schema for this data source.
func (d *siteSecurityPolicyLocalPrefixDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *siteSecurityPolicyLocalPrefixDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *siteSecurityPolicyLocalPrefixDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterSiteSecurityPolicyLocalPrefix
	...
	get_path := "/sdwan/v2.1/api/sites/{site_id}/ngfwsecuritypolicylocalprefixes/{prefix_id}"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_site_security_policy_local_prefix", (*list_request.ResponseErr).Error())
		}
		return
	}
	...
	for _, item := range response.Items {
		...
		var state dsModelSiteSecurityPolicyV2N1PrefixAssociationScreen
		...
		// if found, exit
		if json_err != nil {
			resp.Diagnostics.AddError("error in json unmarshal to SiteSecurityPolicyV2N1PrefixAssociationScreen", json_err.Error())
			return
		}

		// lets copy all items into state schema=SiteSecurityPolicyV2N1PrefixAssociationScreen
