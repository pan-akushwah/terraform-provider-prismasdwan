...
// Data source.
var (
	_ datasource.DataSource              = &elementCellularModuleSimSecurityDataSource{}
	_ datasource.DataSourceWithConfigure = &elementCellularModuleSimSecurityDataSource{}
)
...
//	     }
//	  }
func NewElementCellularModuleSimSecurityDataSource() datasource.DataSource {
	return &elementCellularModuleSimSecurityDataSource{}
}

type elementCellularModuleSimSecurityDataSource struct {
	client *sdwan.Client
}

type dsModelWithFilterElementCellularModuleSimSecurity struct {
	...
	Items        []*dsModelSimSecurityScreen `tfsdk:"items"`
}

// Metadata returns the data source type name.
func (d *elementCellularModuleSimSecurityDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_element_cellular_module_sim_security"
}

// Schema defines the schema for this data source.
func (d *elementCellularModuleSimSecurityDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *elementCellularModuleSimSecurityDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *elementCellularModuleSimSecurityDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {

	var state_with_filter dsModelWithFilterElementCellularModuleSimSecurity
	...
	get_path := "/sdwan/v2.0/api/elements/{element_id}/cellular_modules/{cellular_module_id}/sim_security/{sim_security_id}"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_element_cellular_module_sim_security", (*list_request.ResponseErr).Error())
		}
		return
	}
