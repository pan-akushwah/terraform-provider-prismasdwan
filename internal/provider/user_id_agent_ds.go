...
// Data source.
var (
	_ datasource.DataSource              = &userIdAgentDataSource{}
	_ datasource.DataSourceWithConfigure = &userIdAgentDataSource{}
)
...
//	     NewUserIdAgentDataSource,
//	     // -- append next datasource above -- //
//	     }
//	  }
func NewUserIdAgentDataSource() datasource.DataSource {
	return &userIdAgentDataSource{}
}

type userIdAgentDataSource struct {
	client *sdwan.Client
}

// Metadata returns the data source type name.
func (d *userIdAgentDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = "prismasdwan_user_id_agent"
}

// Schema defines the schema for this data source.
func (d *userIdAgentDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
...
func (d *userIdAgentDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *userIdAgentDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if read_request.ResponseErr != nil {
		if IsObjectNotFound(*read_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_user_id_agent", (*read_request.ResponseErr).Error())
		}
		return
	}
