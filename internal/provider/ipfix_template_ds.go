...
func (d *ipfixTemplateDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	var state_with_filter dsModelWithFilterIpfixTemplate
	...
	get_path := "/sdwan/v2.0/api/ipfixtemplates/{template_id}"
	...
	if list_request.ResponseErr != nil {
		if IsObjectNotFound(*list_request.ResponseErr) {
			...
			resp.Diagnostics.AddError("error reading prismasdwan_ipfix_template", (*list_request.ResponseErr).Error())
		}
		return
	}
